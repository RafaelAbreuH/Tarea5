<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="cCategorias.aspx.cs" Inherits="Tarea5.UI.Consultas.cCategorias" %>
            ...
            <div class="form-row justify-content-center">
                ...
                <div class="form-group col-md-2">
                    ...
                    <asp:DropDownList ID="FiltroDropDownList" CssClass="form-control" runat="server">
                        ...
                        <asp:ListItem>Id Categoria</asp:ListItem>
                        <asp:ListItem>Categoria</asp:ListItem>
                        <asp:ListItem>Promedio Perdido</asp:ListItem>
                    </asp:DropDownList>
                </div>
                <%--Criterio--%>
            ...
            <div class="table-responsive">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-row justify-content-center">
                            <asp:GridView ID="CategoriaGridView" runat="server" class="table table-condensed table-bordered table-responsive" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                                <AlternatingRowStyle BackColor="LightSkyBlue" />
                                <Columns>
                                    <asp:BoundField DataField="CategoriaId" HeaderText="CategoriaId" />
                                    <asp:BoundField DataField="Fecha" HeaderText="Fecha" />
                                    <asp:BoundField DataField="Categoria" HeaderText="Categoria" />
                                    <asp:BoundField DataField="PromedioPerdido" HeaderText="Promedio Perdido" />
                                </Columns>
