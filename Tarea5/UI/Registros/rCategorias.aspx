<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="rCategorias.aspx.cs" Inherits="Tarea5.UI.Registros.rCategorias" %>
                ...
                <article class="card-body">
                    <form>
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <div class="container">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox class="form-control" ID="CategoriaTextBox" placeholder="Categoria" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="CategoriaRFV" runat="server" ErrorMessage="No puede estar vacío" ControlToValidate="CategoriaTextBox" Display="Dynamic" ForeColor="Red" ValidationGroup="Guardar">*No puede estar vacío</asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-md-offset-3">
                            <div class="container">
                                <div class="form-group">
                                    <asp:Label ID="Label2" runat="server" Text="Promedio Perdido"></asp:Label>
                                    <asp:TextBox class="form-control" ID="PromedioPerdidoTextBox" runat="server" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>
                        </div>
